...
def main2():
	...
	for i in variables:
		if i == 'V1' or i == 'V16' or i == 'V21' or i == 'V23' or i == 'V5':
			domains[i] = {"Yellow","White"} 
		elif i == 'V2' i == 'V4' or i == 'V8' or i == 'V10' or i == 'V12' or i == 'V13' or i == 'V14' or i == 'V15' or i == 'V17' or i == 'V19':
	...
	def picapix_contraint_(A,a,B,b, invert=True):
		def picapix_constraint(A,a,B,b,invert=True):
	    if A == 'V1' and B == 'V2' or A  =='V2' and B == 'V1':
	    	return a == b
	    if A == 'V1' and B == 'V3' or A == 'V3' and B == 'V1':
